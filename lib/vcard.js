...
vCard.prototype = {
  ...
  /**
   * Get the Name:
   * returns Property fn or N of the vCard.
   */
  getName: function() {
    if (this.data.fn !== undefined) {
      return card.data.fn._data;
    } else if (this.data.N !== undefined) {
      return card.data.N._data.split(";").join(" ");
    }
  },
  ...
  parse: function( value ) {
    ...
    if( this.version && !vCard.isSupported( this.version ) )
